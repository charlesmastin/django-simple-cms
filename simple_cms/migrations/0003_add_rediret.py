...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Navigation.redirect_url'
        db.add_column('simple_cms_navigation', 'redirect_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Navigation.redirect_url'
        db.delete_column('simple_cms_navigation', 'redirect_url')
