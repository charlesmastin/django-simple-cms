...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Block', fields ['key']
        db.create_unique('simple_cms_block', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Block', fields ['key']
        db.delete_unique('simple_cms_block', ['key'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 7, 16, 35, 27, 297301)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 7, 16, 35, 27, 297168)'}),
