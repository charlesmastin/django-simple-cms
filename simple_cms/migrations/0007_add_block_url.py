...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Block.url'
        db.add_column('simple_cms_block', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Block.target'
        db.add_column('simple_cms_block', 'target', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Block.url'
        db.delete_column('simple_cms_block', 'url')

        # Deleting field 'Block.target'
        db.delete_column('simple_cms_block', 'target')
