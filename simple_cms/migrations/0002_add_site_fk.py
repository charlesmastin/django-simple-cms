...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Navigation.site'
        db.add_column('simple_cms_navigation', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='pages', to=orm['sites.Site']), keep_default=False)

        # Adding unique constraint on 'Navigation', fields ['site', 'parent', 'slug']
        db.create_unique('simple_cms_navigation', ['site_id', 'parent_id', 'slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Navigation', fields ['site', 'parent', 'slug']
        db.delete_unique('simple_cms_navigation', ['site_id', 'parent_id', 'slug'])

        # Deleting field 'Navigation.site'
        db.delete_column('simple_cms_navigation', 'site_id')
