...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Seo'
        db.create_table('simple_cms_seo', (
        ...
        db.send_create_signal('simple_cms', ['Seo'])

        # Adding unique constraint on 'Seo', fields ['content_type', 'object_id']
        db.create_unique('simple_cms_seo', ['content_type_id', 'object_id'])

        # Deleting field 'Navigation.seo_description'
        db.delete_column('simple_cms_navigation', 'seo_description')

        # Deleting field 'Navigation.seo_keywords'
        db.delete_column('simple_cms_navigation', 'seo_keywords')

        # Deleting field 'Navigation.seo_title'
        db.delete_column('simple_cms_navigation', 'seo_title')


    def backwards(self, orm):
        
        # Removing unique constraint on 'Seo', fields ['content_type', 'object_id']
        db.delete_unique('simple_cms_seo', ['content_type_id', 'object_id'])

        # Deleting model 'Seo'
        db.delete_table('simple_cms_seo')

        # Adding field 'Navigation.seo_description'
        db.add_column('simple_cms_navigation', 'seo_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Navigation.seo_keywords'
        db.add_column('simple_cms_navigation', 'seo_keywords', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Navigation.seo_title'
        db.add_column('simple_cms_navigation', 'seo_title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
