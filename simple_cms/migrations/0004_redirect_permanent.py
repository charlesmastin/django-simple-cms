...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Navigation.redirect_permanent'
        db.add_column('simple_cms_navigation', 'redirect_permanent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Navigation.redirect_permanent'
        db.delete_column('simple_cms_navigation', 'redirect_permanent')
