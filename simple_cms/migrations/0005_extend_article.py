...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('simple_cms_article', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Article.target'
        db.add_column('simple_cms_article', 'target', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Article.display_title'
        db.add_column('simple_cms_article', 'display_title', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.url'
        db.delete_column('simple_cms_article', 'url')

        # Deleting field 'Article.target'
        db.delete_column('simple_cms_article', 'target')

        # Deleting field 'Article.display_title'
        db.delete_column('simple_cms_article', 'display_title')
