...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'simple_cms_category', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'simple_cms_category', 'description')
    ...
    models = {
        ...
        u'kabam.articletranslation': {
            'Meta': {'object_name': 'ArticleTranslation'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'boilerplate': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['translated_model.Language']"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'pullquote': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'pullquote_citation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'sub_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
        ...
        u'kabam.navigationtranslation': {
            'Meta': {'object_name': 'NavigationTranslation'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'hero_text': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['translated_model.Language']"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'text': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
