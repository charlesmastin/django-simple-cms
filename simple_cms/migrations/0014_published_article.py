...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.publish_start'
        db.add_column(u'simple_cms_article', 'publish_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Article.publish_end'
        db.add_column(u'simple_cms_article', 'publish_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.publish_start'
        db.delete_column(u'simple_cms_article', 'publish_start')

        # Deleting field 'Article.publish_end'
        db.delete_column(u'simple_cms_article', 'publish_end')
